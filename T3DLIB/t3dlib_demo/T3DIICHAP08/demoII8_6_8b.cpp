// DEMOII8_6_8b.CPP - flat shading demo with z-sorting (8-bit version)
// READ THIS!
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        if (lighting_mode==1)
           Light_RENDERLIST4DV1_World(&rend_list, &cam, lights, 4);
        ...
        if (wireframe_mode  == 1)
           ...
           Draw_RENDERLIST4DV1_Solid2(&rend_list, back_buffer, back_lpitch);
