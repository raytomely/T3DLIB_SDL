// DEMOII13_5.CPP - bounding volumes/octree demo
// READ THIS!
...
BHV_NODEV1      bhv_tree;               // the bounding hierarchical volume tree
...
OBJ_CONTAINERV1   scene_objects[NUM_SCENE_OBJECTS]; // positions of scenery objects
