// DEMOII13_2.CPP - BSP Demo with backface culling
// READ THIS!
        ...
        switch(editor_state)
        {
            ...
            case EDITOR_STATE_VIEW: ///////////////////////////////////////////////
            {
                ...
                if (bsp_backface_mode == 1)
                {
                   ...
                   Bsp_Insertion_Traversal_RemoveBF_RENDERLIST4DV2(&rend_list, bsp_root, &cam, 1);
                }
                else
                {
                ...
                sprintf(work_string,"Lighting [%s]: Ambient=%d, Infinite=%d, BckFceRM [%s], BSP Backface Cull [%s], Zsort [%s], Zbuffer [%s]",
                ...
                sprintf(work_string,"Polys Rendered: %d, Polys lit: %d, Polys Inserted into BSP: %d", debug_polys_rendered_per_frame, debug_polys_lit_per_frame, polycount);
