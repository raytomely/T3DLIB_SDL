...
int Game_Init(void *parms)
{
    ...
    Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
                                ...
                                "earthheightmap02.bmp",  // filename of height bitmap encoded in 256 colors
                                "earthcolormap01.bmp",   // filename of texture map
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        // draw the sky
        draw_rectangle(0,0, WINDOW_WIDTH, WINDOW_HEIGHT*.38, RGB16Bit(50,100,255));

        // draw the ground
        draw_rectangle(0,WINDOW_HEIGHT*.38, WINDOW_WIDTH, WINDOW_HEIGHT, RGB16Bit(25,50,110));
