// DEMOII9_4.CPP - Tank demo with gouraud shading and texture mapping
// READ THIS!
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        // draw the sky
        draw_rectangle(0,0, WINDOW_WIDTH, WINDOW_HEIGHT/2, RGB16Bit(0,35,50));


        // draw the ground
        draw_rectangle(0,WINDOW_HEIGHT/2-1, WINDOW_WIDTH, WINDOW_HEIGHT, RGB16Bit(20,12,0));
