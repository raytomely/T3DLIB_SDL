...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        #if 1
        // draw the sky
        draw_rectangle(0,0, WINDOW_WIDTH, WINDOW_HEIGHT/2, rgblookup[RGB16Bit565(0,35,50)]);

        // draw the ground
        draw_rectangle(0,WINDOW_HEIGHT/2-1, WINDOW_WIDTH, WINDOW_HEIGHT, rgblookup[RGB16Bit565(20,12,0)]);
