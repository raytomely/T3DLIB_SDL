// DEMOII16_1.CPP - MD2 Animation Demo for benchmarking
// READ THIS!
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        // draw instructions
        draw_text("Press ESC to exit. Press <H> for Help.", 0, 0, RGB(255,255,255));
        ...
        if (help_mode==1)
        {
            ...
            draw_text("<Z>..............Toggle Z-sorting.", 0, text_y+=12, RGB(255,255,255));
            draw_text("<1>,<2>..........Previous/Next Animation.", 0, text_y+=12, RGB(255,255,255));
            draw_text("<3>,<4>..........Play Animation Single Shot/Looped.", 0, text_y+=12, RGB(255,255,255));
        ...
        sprintf(work_string,"Lighting [%s]: Ambient=%d, Infinite=%d, Point=%d, BckFceRM [%s], Zsort[%s]",
                                                                                         ...
                                                                                         ((zsort_mode == 1) ? "ON" : "OFF") );
        draw_text(work_string, 0+1, WINDOW_HEIGHT-34+1, RGB(0,0,0));
        draw_text(work_string, 0, WINDOW_HEIGHT-34, RGB(255,255,255));
        ...
        draw_text(work_string, 0+1, WINDOW_HEIGHT-34-2*16+1, RGB(0,0,0));
        draw_text(work_string, 0, WINDOW_HEIGHT-34-2*16, RGB(255,255,255));

        sprintf(work_string,"CAM [%5.2f, %5.2f, %5.2f], CELL [%d, %d]",  cam.pos.x, cam.pos.y, cam.pos.z, cell_x, cell_y);
        draw_text(work_string, 0+1, WINDOW_HEIGHT-34-3*16+1, RGB(0,0,0));
        draw_text(work_string, 0, WINDOW_HEIGHT-34-3*16, RGB(255,255,255));
