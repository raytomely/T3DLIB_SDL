...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        {
            // draw help menu
            draw_text("<A>..............Toggle ambient light source.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<I>..............Toggle infinite light source.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<P>..............Toggle point light source.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<S>..............Toggle spot light source.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<N>..............Next object.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<W>..............Toggle wire frame/solid mode.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<B>..............Toggle backface removal.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<S>..............Toggle Z sorting.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<H>..............Toggle Help.", 0, text_y+=12, RGB(0,0,0));
            draw_text("<ESC>............Exit demo.", 0, text_y+=12, RGB(0,0,0));
