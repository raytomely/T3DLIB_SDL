// DEMOII12_9.CPP - Bilinear interpolation demo
// READ THIS!
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        sprintf(work_string,"Lighting [%s]: Ambient=%d, Infinite=%d, Point=%d, Spot=%d, Zsort [%s], Bilinear Filtering [%s]",
