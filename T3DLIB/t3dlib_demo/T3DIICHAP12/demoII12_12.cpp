// DEMOII12_12.CPP - multipass Alpha Blending/reflection demo
// READ THIS!
...
#define NUM_SCENE_OBJECTS     25    // number of scenery objects
#define UNIVERSE_RADIUS       1750  // size of universe
#define MAX_VEL               10   // maxium velocity of objects
...
OBJECT4DV2      obj_array[NUM_OBJECTS], // array of objects
                ...
                obj_terrain;            // the terrain object
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        if (help_mode==1)
        {
            ...
            draw_text("<N>..............Enable next rendering pass.", 0, text_y+=12, RGB(255,255,255));
