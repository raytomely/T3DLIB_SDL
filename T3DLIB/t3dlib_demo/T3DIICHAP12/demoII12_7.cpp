// DEMOII12_7.CPP - perspective texturing demo with support for linear piecewise
// READ THIS!
...
int Game_Init(void *parms)
{
    ...
    Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
                                ...
                                "checker2562562.bmp",   // filename of texture map
...
int Game_Main(void *parms)
{
    ...
    static char  *perspective_modes[3] = {"AFFINE", "LINEAR PIECEWISE", "PERSPECTIVE CORRECT" };
