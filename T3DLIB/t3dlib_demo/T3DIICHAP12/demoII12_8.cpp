// DEMOII12_8.CPP - hybrid distance based texturing
// READ THIS!
...
int Game_Init(void *parms)
{
    ...
    Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
                                ...
                                "checkerheight03.bmp",   // filename of height bitmap encoded in 256 colors
...
int Game_Main(void *parms)
{
    ...
    static float zdist1 = 400,   // perspective from 0 - zdist1,
                 zdist2 = 1000;  // linear from zdist1 - zdist2, affine > zdist2
    ...
    while(main_loop)
    {
        ...
        if (keystate[KBD_2])
        {
           if (++zdist1 >= zdist2) zdist1 = zdist2-1;
        ...
        if (keystate[KBD_3])
        {
           if (--zdist2 <= zdist1 ) zdist2 = zdist1+1;
        ...
        if (wireframe_mode  == 1)
        {
           ...
           // draw rendering list with hybrid texturing
           Draw_RENDERLIST4DV2_Hybrid_Textured_SolidINVZB_16(&rend_list,
                                           back_buffer, back_lpitch,
                                           (UCHAR *)zbuffer.zbuffer,
                                           WINDOW_WIDTH*4,
                                           zdist1, zdist2);
        ...
        sprintf(work_string,"Lighting [%s]: Ambient=%d, Infinite=%d, Point=%d, BckFceRM [%s] Z-Dist 1 [%f], Z-Dist 2 [%f]",
        ...
        if (help_mode==1)
        {
            ...
            draw_text("<1>,<2>..........Decrease/Increase Z-Distance 1.", 0, text_y+=12, RGB(255,255,255));
            draw_text("<3>,<4>..........Decrease/Increase Z-Distance 2.", 0, text_y+=12, RGB(255,255,255));
