// DEMOII14_1.CPP - simple shadow demo
// READ THIS!
...
int Game_Init(void *parms)
{
    ...
    Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
                                ...
                                "grass256_256_02.bmp", //"checker2562562.bmp",   // filename of texture map
    ...
    VECTOR4D_INITXYZ(&vscale, 80, 80, 80);
...
int Game_Main(void *parms)
{
    ...
    while(main_loop)
    {
        ...
        // draw the sky
        draw_rectangle(0,0, WINDOW_WIDTH, WINDOW_HEIGHT, RGB16Bit(255,120,255));
