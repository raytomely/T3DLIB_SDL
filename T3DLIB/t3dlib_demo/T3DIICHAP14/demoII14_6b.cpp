// DEMOII14_6b.CPP - shadow demo with lightmapping and fan model
// READ THIS!
// using dark map and lightsource for opposite effect
...
int Game_Init(void *parms)
{
    ...
    {
        sprintf(buffer,"fanlightmaps_0%dc.bmp",index+1);
